...
export default function SincronizacaoTiposNegociacaoPage() {
  ...
  const loadData = async () => {
    try {
      ...
      fetch('/api/sync/tipos-negociacao?list=true')
        .then(res => res.json())
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Gerencie a sincronização de tipos de negociação entre Sankhya e o Oracle.
            </p>
          </div>
          <Button
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total de Tipos de Negociação</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Tipos de Negociação Sincronizados (Detalhes)</CardTitle>
            <CardDescription>
              Lista de tipos de negociação sincronizados do Sankhya (últimos 500).
            </CardDescription>
          </CardHeader>
          <CardContent>
